...
def parse_args():
    ...
    p.add_argument("apo_str", type=str, help="PDB-file containing structure.")
    p.add_argument("holo_name", type=str, help="holo pdb name")
    p.add_argument("apo_name", type=str, help="holo pdb name")
    args = p.parse_args()
    return args
